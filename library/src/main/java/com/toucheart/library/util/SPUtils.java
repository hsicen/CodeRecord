 ...
 * 作用：
 * 描述：SharePreference相关工具类
 */
public class SPUtils {

    private static Map<String, SPUtils> mSPMap = new HashMap<>();
    ...
    private SPUtils(String spName) {
        mSp = ContextUtil.withContext().getSharedPreferences(spName, Context.MODE_PRIVATE);
    }
