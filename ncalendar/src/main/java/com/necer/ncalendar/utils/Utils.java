...
public class Utils {
     ...
     * 判断是否为本月之后的时间
     *
     * @param dateTime 被判断日期
     * @return boolean
     */
    public static boolean isNextDateWithMonth(DateTime dateTime) {
        boolean isNext;
        DateTime current = DateTime.now();
     ...
     * @return boolean
     */
    public static boolean isNextDateWithDay(DateTime dateTime) {
        boolean isNext;
        DateTime current = DateTime.now();
