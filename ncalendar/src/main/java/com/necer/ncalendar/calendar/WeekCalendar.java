...
public class WeekCalendar extends CalendarPager implements OnClickWeekViewListener {
    ...
    protected void setDateTime(DateTime dateTime) {
        ...
        currectWeekView.setHolidayList(holidayList);
        currectWeekView.setWorkdayList(workdayList);
        currectWeekView.isShowLunar(isShowLunar);
        currectWeekView.setEventList(eventList);
    ...
    public void onClickCurrentWeek(DateTime dateTime) {
        ...
        weekView.setHolidayList(holidayList);
        weekView.setWorkdayList(workdayList);
        weekView.isShowLunar(isShowLunar);
        weekView.setEventList(eventList);
        mSelectDateTime = dateTime;
        lastSelectDateTime = dateTime;
