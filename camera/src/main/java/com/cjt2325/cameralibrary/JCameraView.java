...
public class JCameraView extends FrameLayout implements CameraInterface.CameraOpenOverCallback, SurfaceHolder
    ...
    //录制视频比特率
    public static final int MEDIA_QUALITY_HIGH = 20 * 1024 * 1024;
    public static final int MEDIA_QUALITY_MIDDLE = 16 * 1024 * 1024;
    public static final int MEDIA_QUALITY_LOW = 12 * 1024 * 1024;
    public static final int MEDIA_QUALITY_POOR = 8 * 1024 * 1024;
    public static final int MEDIA_QUALITY_FUNNY = 4 * 1024 * 1024;
    public static final int MEDIA_QUALITY_DESPAIR = 2 * 1024 * 1024;
    public static final int MEDIA_QUALITY_SORRY = 1024 * 1024;
    ...
    private void initView() {
        ...
        mVideoView = (SurfaceView) view.findViewById(R.id.video_preview);
            ...
            public void recordShort(final long time) {
                ...
                postDelayed(new Runnable() {
                    ...
                    public void run() {
                        ...
                        mCaptureLayout.setTip("轻触拍照，长按摄像");
                    }
                }, 1500 - time);
            }
