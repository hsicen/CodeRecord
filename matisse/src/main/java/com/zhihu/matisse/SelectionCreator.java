...
public final class SelectionCreator {
    ...
    public SelectionCreator title(String title) {
        mSelectionSpec.mPictureTitle = title;
        return this;
    }

    public SelectionCreator canPreView(boolean preview) {
        mSelectionSpec.canPreView = preview;
        return this;
    }
